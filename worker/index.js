...
<body data-page="${route}">
  ...
  <nav class="mobile-nav" aria-label="App navigation"><a href="/" class="${route==='home'?'active':''}"><b>⌂</b>Home</a><a href="/collection" class="${route==='collection'?'active':''}"><b>▦</b>Collection</a><a href="/scan" class="${route==='scan'?'active':''}"><b>◎</b>Scan</a><a href="/account" class="${route==='account'?'active':''}"><b>●</b>Account</a></nav>
...
export default {
  async fetch(request, env) {
    ...
    const routes={"/":"home","/collection":"collection","/scan":"scan","/account":"account","/reset-password":"reset-password"};
